...
function zClass(z: number | null, higherIsBetter: boolean | null): "good" | "warn" | "flat" {
...
export function TodayStrip({ metrics }: { metrics: MetricToday[] }) {
  return (
    <div className="grid">
      {metrics.map((m) => {
        ...
        const delta =
          m.mean30 != null ? m.value - m.mean30 : null;
        return (
          <div className="card" key={m.metric}>
